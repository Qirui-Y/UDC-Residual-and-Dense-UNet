...
#### Test
- Download link of trained model: https://pan.baidu.com/s/1wvYINJeWQaGWaTmwnW60JQ (PW: crfq)
- cd codes
- python  prep_result.py 
It is worth noting that when testing, you need to put the tested .mat file in ‘codes/poled_test_display.mat’.
