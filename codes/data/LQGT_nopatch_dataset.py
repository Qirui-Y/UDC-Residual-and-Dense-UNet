...
class LQGTDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.opt['phase'] == 'train':
            ...
            #img_GT = cv2.resize(np.copy(img_GT), (img_GT.shape[1]//2, img_GT.shape[0]//2), interpolation=cv2.INTER_CUBIC)
            #img_LQ = cv2.resize(np.copy(img_LQ), (img_LQ.shape[1]//2, img_LQ.shape[0]//2), interpolation=cv2.INTER_CUBIC)
